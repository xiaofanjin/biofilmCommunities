...
//these images can be downloaded as tiff files from bioimage archive
//after opening tiff files as stack in ImageJ, use this macro to reshape them into XYZCT hyperstack
